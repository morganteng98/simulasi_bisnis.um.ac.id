<?php $this->load->view("user/include/head.php"); ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            <h1>Welcome to Bussiness Simulation</h1>
        ...
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <img src="assets/user/assets/img/hero-img.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="image col-xl-5 d-flex align-items-stretch justify-content-center order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/user/assets/img/features.svg" class="img-fluid" alt="">
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="assets/user/assets/img/details-1.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="assets/user/assets/img/details-2.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="assets/user/assets/img/details-3.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="assets/user/assets/img/details-4.png" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
    ...
    <!-- <section id="gallery" class="gallery">
       gak dipake soale mencar
    </section> -->
    <!-- End Gallery Section -->

    <!-- ======= Testimonials Section ======= -->
    <!-- <section id="testimonials" class="testimonials section-bg">
      gak di pake soale mencar
    </section>
  ...
  <footer id="footer">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Simulasi Bisnis</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
